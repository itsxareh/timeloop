...
declare module "fs" {
    ...
    export namespace mkdir {
         ...
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * @param options Either the file mode, or an object optionally specifying the file mode and whether parent folders
         * should be created. Ifptr@UINexusTransportFactory@NexusTransport@Mso@@@std@@AEBV?$shared_ptr@VIThrottlingStrategy@NexusTransport@Mso@@@5@AEBV?$shared_ptr@VIRetryStrategy@NexusTransport@Mso@@@5@@Z@  ð„H€           .?AV<lambda_1>@?1??SetNexusUploadDisabled@NexusTransportClient@NexusTransport@Mso@@UEAAX_N@Z@   ð„H€           .?AV<lambda_1>@?1??StartTaskIfNotRunning@RetryStrategy@NexusTransport@Mso@@AEAAXXZ@             ð„H€           .?AU?$default_delete@UIActivityProfilerListener@Telemetry@Mso@@@std@@           ð„H€           .?AV?$FunctorThrow@$$A6A?AV?$unordered_map@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@VAnyType@Mso@@U?$hash@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@U?$equal_to@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@VAnyType@Mso@@@std@@@2@@std@@XZ@Mso@@           ð„H€           .?AU?$deleter@V?$shared_ptr@$$BY0A@E@boost@@@blob@bond@@        ð„H€           .?AU?$checked_array_deleter@E@boost@@   ð„H€           .?AUStreamException@bond@@      ð„H€           .?AUSerializableExceptionBase@bond@@    ð„H€           .?AVException@bond@@    ð„H€           .?AUCoreException@bond@@        ð„H€           .?AVSegFaultException@Storage@@ ð„H€           .?AV?$FunctorThrow@$$A6AXXZ@Mso@@       ð„H€           .?AVinvalid_operation@opplx@@   ð„H€           .?AV_Interruption_exception@details@opplx@@     ð„H€           .?AU?$error_info_injector@Vfailure@ios_base@std@@@exception_detail@boost@@      ð„H€           .?AV?$clone_impl@U?$error_info_injector@Vfailure@ios_base@std@@@exception_detail@boost@@@exception_detail@boost@@       ð„H€           .?AVbad_lexical_cast@boost@@            ð„H€           .?AU?$error_info_injector@Vbad_lexical_cast@boost@@@exception_detail@boost@@    ð„H€           .?AV?$clone_impl@U?$error_info_injector@Vbad_lexical_cast@boost@@@exception_detail@boost@@@exception_detail@boost@@     ð„H€           .?AUambiguous_result@local_time@boost@@ ð„H€           .?AU?$error_info_injector@Uambiguous_result@local_time@boost@@@exception_detail@boost@@         ð„H€           .?AV?$clone_impl@U?$error_info_injector@Uambiguous_result@local_time@boost@@@exception_detail@boost@@@exception_detail@boost@@  ð„H€           .?AUtime_label_invalid@local_time@boost@@       ð„H€           .?AU?$error_info_injector@Utime_label_invalid@local_time@boost@@@exception_detail@boost@@       ð„H€           .?AV?$clone_impl@U?$error_info_injector@Utime_label_invalid@local_time@boost@@@exception_detail@boost@@@exception_detail@boost@@        ð„H€           .?AUbad_year@gregorian@boost@@          ð„H€           .?AU?$error_info_injector@Ubad_year@gregorian@boost@@@exception_detail@boost@@  ð„H€           .?AV?$clone_impl@U?$error_info_injector@Ubad_year@gregorian@boost@@@exception_detail@boost@@@exception_detail@boost@@   ð„H€           .?AUbad_weekday@gregorian@boost@@       ð„H€           .?AU?$error_info_injector@Ubad_weekday@gregorian@boost@@@exception_detail@boost@@               ð„H€           .?AV?$clone_impl@U?$error_info_injector@Ubad_weekday@gregorian@boost@@@exception_detail@boost@@@exception_detail@boost@@        ð„H€           .?AUbad_day_of_year@gregorian@boost@@           ð„H€           .?AU?$error_info_injector@Ubad_day_of_year@gregorian@boost@@@exception_detail@boost@@           ð„H€           .?AV?$clone_impl@U?$error_info_injector@Ubad_day_of_year@gregorian@boost@@@exception_detail@boost@@@exception_detail@boost@@    ð„H€           .?AUbad_month@gregorian@boost@@ ð„H€           .?AU?$error_info_injector@Ubad_month@gregorian@boost@@@exception_detail@boost@@ ð„H€           .?AV?$clone_impl@U?$error_info_injector@Ubad_month@gregorian@boost@@@exception_detail@boost@@@exception_detail@boost@@  ð„H€           .?AUbad_offset@local_time@boost@@       ð„H€           .?AU?$error_info_injector@Ubad_offset@local_time@boost@@@exception_detail@boost@@               ð„H€           .?AV?$clone_impl@U?$error_info_injector@Ubad_offset@local_time@boost@@@exception
